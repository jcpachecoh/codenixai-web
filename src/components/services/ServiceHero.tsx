  ...
  return (
    <section className="relative pt-32 pb-20 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <motion.div
          className="absolute top-20 right-20 w-96 h-96 bg-primary-blue/20 rounded-full blur-3xl"
          animate={{
            scale: [1, 1.2, 1],
            opacity: [0.2, 0.3, 0.2],
          }}
        ...
        />
        <motion.div
          className="absolute bottom-20 left-20 w-96 h-96 bg-primary-purple/20 rounded-full blur-3xl"
          animate={{
            scale: [1.2, 1, 1.2],
            opacity: [0.2, 0.3, 0.2],
          }}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.div
            ...
            className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-primary-blue to-primary-purple rounded-2xl text-white mb-8"
          >
            {serviceData.icon}
          </motion.div>

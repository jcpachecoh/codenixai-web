...
export default function Footer() {
  ...
  const socialLinks = [
    {
      href: "https://www.instagram.com/codenix.ai/",
      icon: "instagram",
      label: "Instagram",
    },
    {
      href: "https://linkedin.com/company/codenixai",
      icon: "linkedin",
      label: "LinkedIn",
    },
    ...
    <footer className="bg-dark-secondary py-12">
      <div className="container mx-auto px-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start space-x-2">
                ...
                <span className="text-trust-gray-400 text-base">
                  {t("email")}
                </span>
              </li>
            </ul>
        ...
        <div className="border-t border-trust-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-trust-gray-500 text-base mb-4 md:mb-0">
            {t("company")}
          </p>

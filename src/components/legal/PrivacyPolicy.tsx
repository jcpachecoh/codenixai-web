...
import { ChevronDown, Shield, Lock, Eye, Zap } from "lucide-react";
...
const PrivacyPolicy = () => {
  ...
  const icons = [Eye, Zap, Lock, Shield, Eye, Shield];
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center mb-16 space-y-4">
            ...
            <h1 className="text-6xl md:text-7xl gradient-text font-bold text-transparent mb-6 leading-tight">
                        ...
                        <div className="flex-1">
                          ...
                          {!isExpanded && (
                            <p className="text-gray-400 text-sm line-clamp-2 group-hover:text-gray-300 transition-colors">
                              {t(
                                `legal.privacy.sections.${section}.description`
                              )}
                            </p>
                          )}
                        </div>

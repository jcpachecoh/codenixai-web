...
const getBlogPost = async (slug: string, locale: string): Promise<BlogPost | null> => {
  const posts: Record<string, BlogPost> = {
    'future-of-ai-software-development': {
      ...
      imageAlt: locale === 'en' ? 'AI and machine learning code on computer screen' : 'Código de IA y machine learning en pantalla de computadora',
      imageCredit: 'Photo by Markus Spiske on Unsplash',
      authorImage: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=150&h=150&auto=format&fit=crop&crop=face',
      tableOfContents: [
        { id: 'key-trends', title: locale === 'en' ? 'Key Trends Shaping the Future' : 'Tendencias Clave', level: 2 },
        { id: 'automated-code', title: locale === 'en' ? 'Automated Code Generation' : 'Generación Automática de Código', level: 3 },
        { id: 'intelligent-testing', title: locale === 'en' ? 'Intelligent Testing' : 'Pruebas Inteligentes', level: 3 },
        { id: 'impact-teams', title: locale === 'en' ? 'Impact on Development Teams' : 'Impacto en Equipos', level: 2 },
        { id: 'challenges', title: locale === 'en' ? 'Challenges and Considerations' : 'Desafíos y Consideraciones', level: 2 },
        { id: 'future-outlook', title: locale === 'en' ? 'Looking Ahead: 2025 and Beyond' : 'Mirando al Futuro: 2025 y Más Allá', level: 2 }
      ],
      content: locale === 'en' ? `
...
<div class="bg-gradient-to-r from-primary-blue/20 to-accent-purple/20 border border-primary-blue/30 rounded-lg p-8 my-12">
  ...
  <div class="flex flex-col sm:flex-row gap-4">
    ...
    'building-intelligent-chatbots': {
      ...
      imageAlt: locale === 'en' ? 'Modern chatbot interface on smartphone' : 'Interfaz de chatbot moderno en smartphone',
      ...
      tableOfContents: [
        { id: 'technology', title: locale === 'en' ? 'Understanding Modern Chatbot Technology' : 'Tecnología de Chatbots Moderna', level: 2 },
        { id: 'planning', title: locale === 'en' ? 'Planning Your Chatbot Strategy' : 'Planificando tu Estrategia', level: 2 },
        { id: 'design', title: locale === 'en' ? 'Design Principles' : 'Principios de Diseño', level: 2 },
        { id: 'implementation', title: locale === 'en' ? 'Technical Implementation' : 'Implementación Técnica', level: 2 }
      ],
      content: locale === 'en' ? `
# Building Intelligent Chatbots: A Complete Guide for Businesses
...
*¿Listo para construir un chatbot inteligente para tu negocio? CodenixAI ofrece servicios completos de desarrollo de chatbots. Contáctanos hoy para transformar tu engagement con clientes usando tecnología inteligente de chatbots.*
    ...
    'rpa-business-automation': {
      ...
      date: '2024-12-05',
      image: 'https://images.unsplash.com/photo-1518186285589-2f7649de83e0?ixlib=rb-4.0.3&auto=format&fit=crop&w=2340&q=80',
      imageAlt: locale === 'en' ? 'Robotic process automation concept' : 'Concepto de automatización robótica de procesos',
      ...
      authorImage: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80',
      tableOfContents: [
        { id: 'rpa-overview', title: locale === 'en' ? 'What is RPA?' : 'Qué es RPA?', level: 2 },
        { id: 'comparison', title: locale === 'en' ? 'RPA vs Traditional Automation' : 'RPA vs Automatización Tradicional', level: 2 },
        { id: 'benefits', title: locale === 'en' ? 'Benefits and Use Cases' : 'Beneficios y Casos de Uso', level: 2 },
        { id: 'implementation', title: locale === 'en' ? 'Implementation Strategy' : 'Estrategia de Implementación', level: 2 }
      ],
      content: locale === 'en' ? `
<div class="prose prose-invert prose-lg max-w-none">
...
<div class="bg-gradient-to-r from-primary-blue/20 to-accent-purple/20 border border-primary-blue/30 rounded-lg p-8 my-12">
  ...
  <div class="flex flex-col sm:flex-row gap-4">
    ...
    'ai-powered-web-development': {
      ...
      imageAlt: locale === 'en' ? 'Web development with AI tools' : 'Desarrollo web con herramientas de IA',
      ...
      authorImage: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80',
      tableOfContents: [
        { id: 'ai-tools', title: locale === 'en' ? 'AI Development Tools' : 'Herramientas de Desarrollo IA', level: 2 },
        { id: 'automation', title: locale === 'en' ? 'Testing Automation' : 'Automatización de Pruebas', level: 2 },
        { id: 'optimization', title: locale === 'en' ? 'Code Optimization' : 'Optimización de Código', level: 2 }
      ],
      content: locale === 'en' ? `
<div class="prose prose-invert prose-lg max-w-none">
...
<p class="text-xl text-gray-300 leading-relaxed mb-8">La IA está revolucionando el desarrollo web con herramientas que automatizan pruebas, optimizan código y mejoran experiencias de usuario.</p>
    ...
    'machine-learning-business-applications': {
      ...
      imageAlt: locale === 'en' ? 'Business analytics and machine learning dashboard' : 'Dashboard de análisis de negocios y machine learning',
      ...
      tags: ['Machine Learning', 'Business Intelligence', 'Data Analytics', 'Case Studies'],
      author: 'CodenixAI Team',
      authorImage: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80',
      tableOfContents: [
        { id: 'applications', title: locale === 'en' ? 'Key Applications' : 'Aplicaciones Clave', level: 2 },
        { id: 'case-studies', title: locale === 'en' ? 'Case Studies' : 'Casos de Estudio', level: 2 },
        { id: 'implementation', title: locale === 'en' ? 'Implementation Guide' : 'Guía de Implementación', level: 2 }
      ],
      content: locale === 'en' ? `
<div class="prose prose-invert prose-lg max-w-none">
...
<p class="text-xl text-gray-300 leading-relaxed mb-8">El machine learning está transformando negocios en todas las industrias. Descubre aplicaciones del mundo real y casos de estudio.</p>
    ...
    'cloud-native-ai-deployment': {
      ...
      imageAlt: locale === 'en' ? 'Cloud computing and AI infrastructure' : 'Computación en la nube e infraestructura de IA',
      imageCredit: 'NASA',
      ...
      authorImage: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80',
      tableOfContents: [
        { id: 'cloud-native', title: locale === 'en' ? 'Cloud-Native Principles' : 'Principios Cloud-Native', level: 2 },
        { id: 'deployment', title: locale === 'en' ? 'Deployment Strategies' : 'Estrategias de Despliegue', level: 2 },
        { id: 'scaling', title: locale === 'en' ? 'Scaling Best Practices' : 'Mejores Prácticas de Escalado', level: 2 }
      ],
      content: locale === 'en' ? `
<div class="prose prose-invert prose-lg max-w-none">
        ...
        <div className="container max-w-4xl">
          ...
          <nav className="mb-8">
            <ol className="flex items-center space-x-2 text-sm text-gray-400">
              <li>
                <Link href={`/${locale}`} className="hover:text-primary-blue transition-colors">
          ...
          <div className="relative aspect-video rounded-xl mb-12 overflow-hidden group">
            ...
            <div className="absolute bottom-4 right-4 bg-black/50 backdrop-blur-sm rounded px-3 py-1">
              <span className="text-white/80 text-xs">Photo by {post.imageCredit}</span>
            </div>
          </div>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <div 
              ...
              dangerouslySetInnerHTML={{ 
                __html: post.content.replace(/\n/g, '<br />').replace(/### /g, '<h3 class="text-white font-bold text-xl mt-8 mb-4">').replace(/## /g, '<h2 class="text-white font-bold text-2xl mt-10 mb-6">').replace(/# /g, '<h1 class="text-white font-bold text-3xl mt-12 mb-8">')
              }} 
            />
          </div>
